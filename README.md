# 客栈前端项目 (Vue 3 + Vite + Element Plus)

这个项目是一个用于展示客栈风貌、活动记录、人员介绍和物品展示的前端演示项目，基于 Vue 3、Vite、Element Plus，前端与后端通过 Axios 通信（本示例用 localStorage 模拟 API）。

快速开始

- 安装依赖（开发机器或服务器需要 Node.js）:
...
- 主页：展示客栈轮播图、主题和简介。
- 活动记录：添加/浏览活动（时间、人员、描述、照片）。
- 人员介绍：人员卡片，展示性格、技能和联系方式。
